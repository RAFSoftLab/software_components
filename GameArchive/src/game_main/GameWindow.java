...
/**
 * The class {@code GameWindow} is the main class of this component.User of this component can extend this
 * class and get game screen with game loop.The game loop is provided by {@code MainThread} class.User 
 * must implement 3 abstract methods of this class to make his game.The {@link #load()},{@link #update()}
 * and {@link #draw()} method.
 * 
 *@see MainThread
 *
 *@author Comexetina
