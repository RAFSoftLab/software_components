...
/**
 * The {@code MainThread} class working in background and allows dynamic in the game.The main function of
 * this class is to call {@link GameWindow#update()} and {@link GameWindow#draw()} method multiple
 * times in second {@link MainThread#targetTime}.This class is vital for game because game must always be 
